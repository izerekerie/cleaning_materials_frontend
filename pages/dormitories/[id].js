...
export default function Dormitory() {
  ...
  return (
    ...
    <div className='flex justify-between w-11/12 p-4'>
            <p className='pl-4 text-blue text-lg font-semibold p-2'>Dormitory Name</p>
          ...
          <div className='flex m-2 mb-4  '>
           <p className='w-1/4 text-xs text-center '>Material</p>
           <p className='w-1/4 text-xs text-center '>Quantity</p>
           <p className='w-1/4 text-xs text-center '>Updated At</p>
           <p className='w-1/4 text-xs text-center'>Action</p>
           
          </div>
    
          <div className='flex m-2 bg-white h-12 w-full  shadow-md p-2 pt-4'>
           <p className='w-1/4 text-xs text-grey text-center '>Mops</p>
          ...
          <div className='flex m-2 bg-white h-12 w-full  shadow-md p-2 pt-4'>
           <p className='w-1/4 text-xs text-grey text-center '>Scrappers</p>
           <p className='w-1/4 text-xs text-center text-grey'>14</p>
           <p className='w-1/4 text-xs text-center text-grey'>12-02-2022 9:12 AM</p>
